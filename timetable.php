  ...
  <header>
    ...
    <nav>
      ...
      <ul class="menu">
        ...
        <li class="current"><a href="file:///F|/gym/fitness-club/timetable.html">Timetable</a></li>
        ...
        <div class="box-shadow">
          <div class="wrap block-2">
            ...
            <div class="col-2">
              ...
              <img src="file:///F|/gym/fitness-club/images/page3-img1.jpg" alt="" class="img-border pad-1">
              <ul class="list-2">
